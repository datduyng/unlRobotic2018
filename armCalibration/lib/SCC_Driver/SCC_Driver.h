...
// update the current position by reference given config coordinate.
...
//  this function configure the arm in a home position coordinate then update the actual current
// coordinate using updatePos() function.
void toFetal(void);
